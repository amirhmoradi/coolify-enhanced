...
**Pro Tier** (5 features — stripped from free builds):
...
- Coolify v4.x running on your server (overlays and Docker base image are validated against upstream **v4.0.0-beta.472**)
