...
| **MCP Server (AI Assistant Integration)** | None | 119+ MCP tools covering all Coolify (and Corelix Platform) API endpoints |
...
- [Feature Details](#feature-details)
  ...
  - [Docker Registry Management](#11-docker-registry-management)
...
- **Enhanced tools** (47+) for permissions, resource backups, custom templates, network management, cluster management, and registry management
...
- Install via `npx @corelixio/platform-mcp`
...
| `CORELIX_NETWORK_ISOLATION_MODE` | `environment` | Isolation mode: `none`, `environment`, `strict` |
...
**Free Tier** (11 features — ship in both editions):
...
**Pro Tier** (4 features — stripped from free builds):
...
- **Public community mirror** — `corelixio/platform` is a CI-managed free-edition mirror for installs, issues, discussions, and public contributions.
...
| `CORELIX_NETWORK_ISOLATION_MODE` | `environment` | Isolation mode: `none`, `environment`, or `strict` |
...
- **Public free mirror** (`corelixio/platform`) — CI-managed snapshot of the free edition, auto-published from the private repo. Community issues and discussions are welcome here.

**For community contributors (free edition):**

1. Fork `corelixio/platform`
...
6. Open a Pull Request against `corelixio/platform`
