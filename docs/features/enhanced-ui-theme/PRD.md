...
7. Support config fallback (`corelix-platform.ui_theme.enabled`) when DB value is absent
...
- **Rendering:** Base layout overlay conditionally injects:
  - `vendor/corelix-platform/theme.css`
...
- `routes/web.php`
- `src/CorelixPlatformServiceProvider.php`
- `docker/Dockerfile`
