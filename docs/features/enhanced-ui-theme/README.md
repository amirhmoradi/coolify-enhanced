...
- `config/corelix-platform.php` — `ui_theme.enabled` (env fallback)
...
- `src/CorelixPlatformServiceProvider.php` — `enhanced_theme_enabled()` helper, theme asset publish
...
- Legacy design and implementation notes are maintained in the canonical private repository for maintainers.
