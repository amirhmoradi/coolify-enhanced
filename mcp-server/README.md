...
A [Model Context Protocol (MCP)](https://modelcontextprotocol.io) server that enables AI assistants to manage [Coolify](https://coolify.io) infrastructure through natural language. Works with both standard Coolify and the [corelix-platform](https://github.com/amirhmoradi/coolify-enhanced) addon.

## Features

- **99+ MCP tools** covering all Coolify API endpoints
- **Enhanced tools** for permissions, resource backups, custom templates, and network management (when corelix-platform is installed)
...
The npm package name stays the same: `@amirhmoradi/coolify-enhanced-mcp`.
