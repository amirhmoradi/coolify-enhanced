...
A [Model Context Protocol (MCP)](https://modelcontextprotocol.io) server that enables AI assistants to manage [Coolify](https://coolify.io) infrastructure through natural language. Works with both standard Coolify and the [corelix-platform](https://github.com/corelixio/platform) addon.
...
The npm package name stays the same: `@corelixio/platform-mcp`.
