...
// conditionally registered when corelix-platform is detected.
// ============================================================
...
// Enhanced tool modules (corelix-platform only)
...
export function createMcpServer({ client, enhanced }: CreateMcpServerOptions): McpServer {
  const serverName = enhanced ? "corelix-platform-mcp" : "coolify-mcp";
