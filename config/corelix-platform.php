...
return [
    ...
    */
    'network_management' => [
        ...
        'isolation_mode' => env('CORELIX_NETWORK_ISOLATION', 'environment'),
    ...
    */
    ...
    |
    */
    'cluster_management' => env('CORELIX_CLUSTER_MANAGEMENT', false),
    'cluster_sync_interval' => (int) env('CORELIX_CLUSTER_SYNC_INTERVAL', 60),
    'cluster_cache_ttl' => (int) env('CORELIX_CLUSTER_CACHE_TTL', 30),
    'cluster_event_retention_days' => (int) env('CORELIX_CLUSTER_EVENT_RETENTION', 7),
